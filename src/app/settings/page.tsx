...
type Section = "general" | "api-keys" | "notifications" | "appearance" | "security";
...
const navSections = [
  ...
  { id: "security" as Section, label: "Security & 2FA", icon: Shield },
                ...
                <div className="mt-4 space-y-3">
                  <div className="flex items-center justify-between rounded-lg border border-border px-4 py-3">
                    <div>
                      ...
                      <p className="mt-0.5 text-xs text-muted">5 attempts per minute, 5-minute lockout</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between rounded-lg border border-border px-4 py-3">
                    <div>
                      ...
                      <p className="mt-0.5 text-xs text-muted">Server-side password validation</p>
                    </div>
                    <span className="rounded-full bg-success/10 px-2 py-0.5 text-[10px] font-medium text-success">Active</span>
                  </div>
                  <div className="flex items-center justify-between rounded-lg border border-border px-4 py-3">
